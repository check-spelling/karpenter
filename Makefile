...
HELM_OPTS ?= --set options.clusterName=${CLUSTER_NAME} --set options.clusterEndpoint=${CLUSTER_ENDPOINT} --set options.awsDefaultInstanceProfile=KarpenterNodeInstanceProfile-${CLUSTER_NAME}
